...
Phase 11의 [완료 근거](../../history/2026-09-17-phase11-data-hypotheses.md#phase11)를 반영한 현재 결정은 보정 **보류**다. 400건은 intake/uncertainty/짧은 QA 교체이고 연결 일반 대화·주제 전환을 직접 보완하지 않는다. 기존 dev 200의 마지막 질문은 학습과 전량 겹치므로 향후 새 split의 질문/부모/seed 계열 분리를 확인해야 한다. 기존 데이터·accepted 238·대기 162행은 그대로 두고 Phase 12 실제 후보 확인 뒤 필요할 때만 새 계약/build를 정한다.
...
- 2026-09-17: S5의 2K/400 교체 계약·질문 중복 한계·7축 가설을 연결했다. 데이터 변경과 생성은 하지 않았으며 검증은 [Phase 11 기록](../../history/2026-09-17-phase11-data-hypotheses.md#phase11)을 따른다.
