...
v1.16의 CPU 25개 통과는 보존한다. 2026-09-15 분리 함수 재현에서는 “오늘 야근했어”, “어제 영화 보고 왔어”, “내일 면접이라 긴장돼”, “이번 주에 운동 시작했어”가 period_request로 분류됐다. 이것은 [Phase 8A](phases/phase-08.md#routing)의 추가 회귀이며 새 구현이나 실제 서비스 재시험 결과가 아니다. S3 지시문도 파일뿐 아니라 formatter 안내까지 포함해 통제한다.
