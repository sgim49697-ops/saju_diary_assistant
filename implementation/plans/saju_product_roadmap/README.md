...
| 앱 상태 | dashboard v1.14 운영 / v1.15 부모·v1.16 의도 후보 CPU 검증·운영 미배포 |
| 현재 문서 작업 | Phase 7 정본화 완료·계산기 범위 동결; 기준 `390ca88`, 원문 3개·841줄 전량 반영 |
| 다음 실행 축 | Phase 8A 앱 오차단 / 8B S3 → Phase 9 S4 → Phase 10~14; 후속 실행 별도 |
...
| 8 | [앱 오차단 / S3 지시문](phases/phase-08.md) | 미실행 | 8A CPU 후보와 8B 최대 96요청 비교를 분리 |
