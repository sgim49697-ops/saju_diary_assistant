...
| 순서 | 문서 | 초기 상태 | 완료 조건 |
|---:|---|---|---|
| 00 | [`00-current-baseline.md`](00-current-baseline.md) | 구현 완료·통합 확인 대기 | 통합 audit가 v1.5·v1.11까지 검증 |
...
- 격리 worktree에는 Git 제외 grounded dialogue·MIX20K-v3 private build가 없으므로 payload를 복사하지 않았다. v1.1 전체 quick audit은 master 통합 뒤 기존 private build 위치에서 최종 확인한다.
