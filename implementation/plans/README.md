...
| 만세력 runtime | v1.4 과거 원국을 부모로 단일 일진 v1.5·conformance v10 `build-46185262164f`·release `saju-runtime-release-v1.5.0-8b1d6ea2d46e`, dashboard v1.11 actual HTTP·GPU·운영 live canary 완료 | master `737846c` 운영 process에서 exact 원국+단일 `day`만 명시 flag로 제한 활성화·feature 기본 off, strict/full Gate·주/월/연·v3.1 차단 |
