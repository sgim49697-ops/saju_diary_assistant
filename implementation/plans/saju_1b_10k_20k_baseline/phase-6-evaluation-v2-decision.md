...
현재 K0·KI10·KI20 final은 고정돼 있고 KI20 `run-1f5d732cae67`의 1 epoch·2,500 step·새 프로세스 reload 5/5가 완료됐다. 다만 이 Phase의 평가 코드·raw 출력·사람 검수·sealed blind 산출물은 아직 생성하지 않았으며 `blind_source_test_inspected=false`다. 다음 실행은 새 학습이 아니라 아래 계약으로 세 모델을 동일 설정에서 평가하는 작업이다.
