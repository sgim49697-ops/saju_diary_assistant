...
def _verify_build(build_root: Path, release: dict[str, Any]) -> dict[str, Any]:
    ...
    if (
        manifest.get("dataset_version") != "mix20k-v3.1-runtime-grounded"
        ...
        or manifest.get("identity", {}).get("runtime_release_id")
        != release["release_id"]
        or manifest.get("identity", {}).get("runtime_release_registry_sha256")
