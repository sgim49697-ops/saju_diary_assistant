# dashboard_product_canary_v3.py - Phase 10의 CPU·합성 화면 검증만 불변 공개 집계로 발행한다.
...
PUBLIC_ROOT = REPO_ROOT / "data/reports/saju_1b_baseline/dashboard-product-canary/v3.0.0"
CODE = (
    "scripts/training/phase5_dashboard_v1_20.py",
    "scripts/training/dashboard_product_policy_v3.py",
    "scripts/training/dashboard_product_session_v3.py",
    ...
    "configs/model_versions/saju_1b_baseline/phase5-dashboard-v1.20.0-product-candidate.json",
    "configs/chat_prompts/saju_product_v1.txt",
    "scripts/evaluation/dashboard_product_canary_v3.py",
    "scripts/evaluation/dashboard_product_ui_canary_v3.cjs",
    "tests/test_dashboard_product_v3.py",
    "tests/test_dashboard_product_http_v3.py",
    "tests/test_dashboard_product_canary_v3.py",
    *("scripts/training/phase5_dashboard_assets/v1.20.0/" + name for name in ("dashboard.js", "dashboard.css", "index.html", "prompt-examples.json")),
)
PARENTS = {
    "data/reports/saju_1b_baseline/dashboard-product-canary/v2.0.0/build-35dc83ce161d/build_manifest.json": "e27e58796dc3e9c2bee866a4cf4d15cc132d9617ee0fa15b2923b456fd4707d1",
    "data/reports/saju_1b_baseline/system-context-s5/v1.0.0/build-27a91a8e21a8/aggregate.json": "bb34e74c7f0dda2b58b1d1c6b4fa868d1ac0c58a2cdca35bbe48312f19ed4150",
    "data/reports/saju_1b_baseline/system-context-s5/v1.0.0/build-27a91a8e21a8/build_manifest.json": "65ef8dd8b4647766d98b5adacf826e1647aae34ed32e9fa3b707510bb3929f7d",
...
TESTS = ("tests.test_dashboard_product_v3", "tests.test_dashboard_product_http_v3", "tests.test_dashboard_product_canary_v3")
TEST_COUNT = 71
...
def policy_cases():
    from tests.test_dashboard_product_v3 import binding_fixture, chart_binding
    ...
    specs = (
        ...
        ("ordinary-day-adverb", "일간 연락드릴게요", "day", "model_generated"),
        ("ordinary-school-slang", "우리 반 일진이 누구야?", "none", "model_generated"),
        ("concept-unrelated-self", "용신이라는 용어는 무슨 의미야? 나는 사실 잘 몰라서.", "day", "model_generated"),
        ("compound-character", "내 일간이 뭐고 성격도 알려줘.", "day", "model_generated"),
        ("compound-comfort", "내 일간이 뭐고 오늘 기분이 안 좋은데 위로도 해줘.", "day", "model_generated"),
        ("ordinary-bible", "신약 성경은 어떤 책들이야?", "day", "model_generated"),
        ("concept-and-fact", "용신의 뜻을 설명하고 내 일간도 알려줘", "day", "model_generated"),
        ("concept-and-personal-calculation", "용신의 뜻을 설명해줘. 나에게 맞는 것을 골라줘", "day", "blocked"),
        ("concept-self-in-same-clause", "나는 용신의 뜻이 궁금해", "day", "model_generated"),
        ("concept-self-and-assessment", "나는 용신의 뜻을 알고 싶은데 내 용신은 뭐야?", "day", "blocked"),
        ("concept-implicit-personal", "나는 용신의 뜻이 궁금하고 신강 여부도 알려줘", "day", "blocked"),
        ("concept-implicit-personal-unbound", "저는 신강의 뜻이 궁금한데 신강인지 아닌지도 알려줘", "none", "blocked"),
        ("concept-assessment-no-subject", "용신의 뜻이 궁금하고 신강 여부도 알려줘", "day", "blocked"),
        ("concept-assessment-no-subject-unbound", "신강의 뜻이 궁금한데 신강인지 아닌지도 알려줘", "none", "blocked"),
        ("concept-assessment-question-ending", "용신의 뜻이 궁금하고 신강인가 알려줘", "day", "blocked"),
        ("concept-assessment-different-term", "격국의 개념이 궁금한데 신약일까 궁금해", "none", "blocked"),
        ("concept-unrelated-choice", "용신이 무슨 뜻이야? 나는 이 옷 중에 뭐가 나을지 골라줘.", "day", "model_generated"),
        ("concept-unrelated-menu", "신강의 뜻이 뭐야? 나는 저녁 메뉴 좀 추천해줘.", "none", "model_generated"),
    )
    rows = []
...
def identity():
    ...
    return {
        "canary_id": "dashboard-product-cpu-v3.0.0", "dashboard_version": "1.20.0",
...
def run_browser():
    result = subprocess.run(["node", str(REPO_ROOT / "scripts/evaluation/dashboard_product_ui_canary_v3.cjs")], cwd=REPO_ROOT, env={**os.environ, "CUDA_VISIBLE_DEVICES": ""}, capture_output=True, text=True, timeout=90, check=False)
...
def evaluate():
    ...
    aggregate = {
        ...
        "dashboard_version": "1.20.0", "candidate_engine": "lora_r16",
