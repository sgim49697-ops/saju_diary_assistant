// dashboard_product_ui_canary_v2.cjs - v1.19 실제 자산을 외부 접속·모델 호출 없이 합성 HTTP로 검증한다.
"use strict";
...
const assets = path.resolve(__dirname, "../training/phase5_dashboard_assets/v1.19.0");
let stage = "시작";
