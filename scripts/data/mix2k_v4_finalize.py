...
from scripts.data.mix2k_v4_teacher_recovery_call178 import (
...
def _teacher_inputs(
    ...
    return (
        ...
        seed_state,
        {
            ...
            "operator_recovery_audit": operator_recovery_audit,
        },
    )
    ...
    summary_bytes = _json_bytes(
        {
            **audit_summary,
            ...
            "operator_recovery_audit": teacher_input_hashes[
