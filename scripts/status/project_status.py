...
<section class="panel"><h2>학습 전 Gate</h2><div class="table-wrap"><table><thead><tr><th>Gate</th><th>상태</th><th>기준</th><th>결과</th></tr></thead><tbody>{gates}</tbody></table></div></section>
