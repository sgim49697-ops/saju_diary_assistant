# test_dashboard_product_canary_v3.py - 제품 CPU 증거의 전량 집계·불변 발행·실패 처리를 검증한다.
...
from scripts.evaluation import dashboard_product_canary_v3 as canary
...
class ProductCanaryTests(unittest.TestCase):
    ...
    def test_failed_missing_or_skipped_tests_are_not_success(self):
        for code, output in ((1, "Ran 71 tests in 1s\nOK\n"), (0, "OK\n"), (0, "Ran 70 tests in 1s\nOK\n"), (0, "Ran 71 tests in 1s\nOK (skipped=1)\n")):
